...
if($userEmail){
    $sql = "SELECT a.C_code, c.Name , a.section, s.F_initials from advised_course2 a, section s, courses c where 
    c.course_code=a.C_code and a.st_id = '$id' and a.section=s.Number and a.C_code=s.Course_code; ";
